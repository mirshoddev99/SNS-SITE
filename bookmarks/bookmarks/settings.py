...
SECRET_KEY = 'django-insecure-4(h2w#3as*e3npm!5_%g%%n(#%k3)twzvo%z11x#hxu4roh*)^'
...
MIDDLEWARE = [
    # external application for tracking debug information
...
# specifying urls to a model
ABSOLUTE_URL_OVERRIDES = {
    'account.Profile': lambda u: reverse_lazy('user_detail', args=[u.username])
}
